...
class Student extends MY_Controller {
	...
	protected function load_header($is_student_cv = false, $title = "Hồ sơ"){
		...
		$data['is_student_cv'] = $is_student_cv;
	...
	public function view_mark(){
		$data = ['marks' => $this->TeacherManagerModel->get_mark(['student_id' => $this->session->uid])];
		self::load_header(false, 'Xem điểm');
		$this->load->view('student/view_mark', $data);
		$this->load->view('student/footer');
	}
